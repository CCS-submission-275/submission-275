...
void Resource::AppendData(const char* data, size_t length) {
  ...
  // :: Forensic ::
  // we can also hook here to record the data here instead of loaderfinish
  // due to the invocation of this function during the replay
  // we do it in the raw resource when the response is on stream
