...
void DOMWindow::DoPostMessage(scoped_refptr<SerializedScriptValue> message,
  ...
  // Forensics
//  int message_id = -1;
//  if (this->IsLocalDOMWindow()) {
//    int message_id =
//        local_dom_window->GetExecutionContext()->CreateMessageEventId();
//    VLOG(7) << "Ports: " << channels.size();
//    EventRecorder::RecordPostMessageEvent(
//        local_dom_window, message_id, message, source_origin, source,
