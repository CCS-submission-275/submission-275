...
class CORE_EXPORT Node : public EventTarget {
 ...
 public:
  ...
  // :: Forensics ::
  void setReplayParserInserted(bool parser_inserted) {parser_inserted_ = parser_inserted;}
  bool ParserInserted(){return parser_inserted_;}

  void SetReplayId(uint32_t replay_id){replay_id_ = replay_id;}
  int32_t GetReplayId() {return replay_id_;}
  int32_t replay_id_ = -1;
  // Forensics
