...
class Attribute {
 ...
 public:
  ...
  // :: Forensics ::
  void SetParserModified(bool parser_modified) {parser_modified_ = parser_modified;}
  bool ParserModified(){return parser_modified_;}
  // Forensics
