...
Element::Element(const QualifiedName& tag_name,
  ...
  if (ForensicReplayEngine::GetInstance()->replay()) {
    ForensicReplayEngine::GetInstance()->VerifyDOMEvent(
        this, ForensicDOMEventType::kCreateNode);
  } else
    DOMModificationRecorder::DidCreateDOMNode(this);
  //
}
...
void Element::WillModifyAttribute(const QualifiedName& name,
  ...
  // :: Forensics
  // DOMModificationRecorder::WillModifyDOMAttr(this, old_value, new_value);
  //
}
...
void Element::DidAddAttribute(const QualifiedName& name,
  ...
  // :: Forensics
  DOMModificationRecorder::DidModifyDOMAttr(this, name, value);
  if (ForensicReplayEngine::GetInstance()->replay()) {
    ForensicReplayEngine::GetInstance()->VerifyDOMAttrEvent(
        this, name, value, ForensicDOMAttrEventType::kModifyAttr);
  }
  //
...
void Element::DidModifyAttribute(const QualifiedName& name,
  ...
  // :: Forensics
  DOMModificationRecorder::DidModifyDOMAttr(this, name, new_value);
  if (ForensicReplayEngine::GetInstance()->replay()) {
    ForensicReplayEngine::GetInstance()->VerifyDOMAttrEvent(
        this, name, new_value, ForensicDOMAttrEventType::kModifyAttr);
  }
  // Forensics
...
void Element::DidRemoveAttribute(const QualifiedName& name,
  ...
  // :: Forensics
  DOMModificationRecorder::DidRemoveDOMAttr(this, name);
  if (ForensicReplayEngine::GetInstance()->replay()) {
    ForensicReplayEngine::GetInstance()->VerifyDOMAttrEvent(
        this, name, old_value, ForensicDOMAttrEventType::kRemoveAttr);
  }
  //
  DispatchSubtreeModifiedEvent();
}
...
void Element::StyleAttributeChanged(
  ...
  // :: Forensics
  DOMModificationRecorder::DidInvalidateStyleAttr(this);
  //
}
