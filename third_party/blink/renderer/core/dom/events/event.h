...
class CORE_EXPORT Event : public ScriptWrappable {
 ...
 public:
  ...
  // :: Forensics ::
  bool replay_event_;
  void SetReplayEvent(bool is_replay_event) {replay_event_ = is_replay_event;}
  bool IsReplayEvent(){return replay_event_;}
  // Forensics
  ...
  void SetRecorded(bool value) { was_recorded_ = value;}
  //
